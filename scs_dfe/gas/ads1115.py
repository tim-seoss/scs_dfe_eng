...
class ADS1115(object):
    ...
    GAIN_6p144 =        0x0000      # ---- 000- ---- ----                  1 bit = 0.1875000 mV
    GAIN_4p096 =        0x0200      # ---- 001- ---- ----    (default)     1 bit = 0.1250000 mV
    GAIN_2p048 =        0x0400      # ---- 010- ---- ----                  1 bit = 0.0625000 mV
    GAIN_1p024 =        0x0600      # ---- 011- ---- ----                  1 bit = 0.0312500 mV
    GAIN_0p512 =        0x0800      # ---- 100- ---- ----                  1 bit = 0.0156250 mV
    GAIN_0p256 =        0x0a00      # ---- 101- ---- ----                  1 bit = 0.0078125 mV
